...
train_data = pd.read_csv(
    '/mnt/c/Users/kings/OneDrive - MMU/Desktop/bip-mental-health-technical-challenge/cleaned_train.csv')


def objective(trial: optuna.trial) -> float:
    seed = 1234
    X, y = train_data.drop(
        columns=['outcome', 'iyear', 'imonth', 'dispcode', 'sexvar']), train_data['outcome']
